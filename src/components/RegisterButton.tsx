...
const RegisterButton: FC<RegisterButtonProps> = ({ eventId, isRegistered }) => {
	...
	return (
		<button onClick={onClick} disabled={leaveMutation.isLoading || joinMutation.isLoading} className="mr-8 rounded-full bg-blue-primary px-8 py-4 text-xs font-extrabold text-white transition-colors hover:bg-blue-700">
