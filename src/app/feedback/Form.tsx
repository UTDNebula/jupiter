...
export default function Form() { 
    ...
    const {handleSubmit} = useForm<z.infer<typeof feedbackFormSchema>>({
    ...
    return (
        <>
          ...
          >
            ...
            <textarea id='rating' name='rating' className="w-4/5 h-15 p-1 text-left  shadow-xl border-gray-500 border-2 rounded-md"></textarea>
            ...
            <textarea id='likes' name='likes' className=" overflow-auto w-4/5 h-15 p-1 text-left  shadow-xl border-gray-500 border-2 rounded-md"></textarea>
            <br></br>
            ...
            <textarea id='dislikes' name='dislikes' className="w-4/5 h-15 p-1 text-left  shadow-xl border-gray-500 border-2 rounded-md"></textarea>
  
            <h3 className="text-md border-t-2 border-slate-200 text-slate-500 pt-2 my-4 ">
              What features would you like to see in Jupiter?
            </h3>
            
            <textarea id='features' name='features' className="w-4/5 h-15 p-1 text-left  shadow-xl border-gray-500 border-2 rounded-md"></textarea>
            <br></br> 
