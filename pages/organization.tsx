...
export default function Directory() {
    return(
        <div>
            ...
            <div style={{justifyItems:"left", display:"grid",  gridTemplateColumns:"1fr 1fr 1fr"}}>
                <div>
